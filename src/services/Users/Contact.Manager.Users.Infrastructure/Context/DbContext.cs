...
namespace Contact.Manager.Users.Infrastructure.Context
{
    public class DbContext : IDbContext
    {
        ...
        public DbContext()
        {
            ...
            var connectionString = "mongodb://<user>:<pass>@cluster0-shard-00-00.8hjil.mongodb.net:27017,cluster0-shard-00-01.8hjil.mongodb.net:27017,cluster0-shard-00-02.8hjil.mongodb.net:27017/<dbname>?ssl=true&replicaSet=atlas-pb9pc3-shard-0&authSource=admin&retryWrites=true&w=majority";
